...
const AddButtonLarge = ({ title, path }) => {
  ...
  return (
    <button onClick={handleButtonClick} className="w-full rounded-xl border border-gray-300 bg-white p-4 text-gray-500 hover:bg-gray-100 hover:text-black dark:border-neutral-600 dark:bg-neutral-700 dark:text-white dark:hover:bg-neutral-600">
