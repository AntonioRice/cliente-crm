      ...
      <div className="h-full overflow-y-auto border-r border-gray-200 bg-white px-3 py-4 dark:border-gray-700 dark:bg-gray-900">
        <ul className="space-y-2 font-extralight">
          ...
          {filteredSidebarItems.map((item) => (
            <li key={item.path}>
              <button onClick={() => navigate(item.path)} className={`group mt-5 flex w-full items-center rounded-lg p-4 hover:bg-gray-100 dark:hover:bg-gray-700 ${getActiveClass(item.path)}`}>
