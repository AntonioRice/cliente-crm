const UruguayFlag = () => {
  return (
    <svg viewBox="-5 -5 945 630" xmlns="http://www.w3.org/2000/svg" className="size-5">
          ...
          <g fill="#fcd116">
            ...
            <g strokeWidth=".6">
              ...
              <path
                ...
                strokeWidth=".278"
              />
              <path d="M-27.361 153.121c-13.014 3.186-14.245 10.862-20.704 8.576" fill="none" strokeWidth=".611" />
            </g>
            <path
            ...
            <g strokeWidth=".6">
              ...
              <path
                ...
                strokeWidth=".278"
              />
              <path d="M-27.361 144.545c-11.455-6.95-17.753-2.392-20.704-8.576" fill="none" strokeWidth=".611" />
              <path d="M-17.009 148.833v-6.112l-33.615 6.112 33.615 6.112v-6.112h-33.615" strokeWidth=".611" />
              ...
              <path
                ...
                strokeWidth=".278"
              />
              <path d="M-21.297 138.481c-3.185-13.014-10.862-14.244-8.576-20.704" fill="none" strokeWidth=".611" />
              <path
                d="M-17.009 148.833l4.322-4.321-28.092-19.448 19.448 28.091 4.322-4.322-23.77-23.77"
                strokeWidth=".611"
              />
              <path
                d="M-17.009 148.833l-4.322 4.322 4.322-4.322-23.77-23.77 19.448 28.092"
                fill="#7b3f00"
                stroke="none"
              />
              <path
              ...
              <path
                ...
                strokeWidth=".278"
              />
              <path d="M-12.72 138.481c6.949-11.455 2.391-17.753 8.575-20.704" fill="none" strokeWidth=".611" />
              <path d="M-17.009 148.833h6.112l-6.112-33.615-6.112 33.615h6.112v-33.615" strokeWidth=".611" />
              ...
              <path
                ...
                strokeWidth=".278"
              />
              <path d="M-6.657 144.545c13.014-3.185 14.245-10.862 20.705-8.576" fill="none" strokeWidth=".611" />
              <path
                d="M-17.009 148.833l4.322 4.322L6.76 125.064l-28.092 19.448 4.322 4.321 23.77-23.77"
                strokeWidth=".611"
              />
              <path
                d="M-17.009 148.833l-4.322-4.321 4.322 4.321 23.77-23.77-28.092 19.449"
                fill="#7b3f00"
                stroke="none"
              />
              <path
              ...
              <path
                ...
                strokeWidth=".278"
              />
              <path d="M-6.657 153.121c11.455 6.95 17.753 2.392 20.705 8.576" fill="none" strokeWidth=".611" />
              <path d="M-17.009 148.833v6.112l33.615-6.112-33.615-6.112v6.112h33.615" strokeWidth=".611" />
              ...
              <path
                ...
                strokeWidth=".278"
              />
              <path d="M-12.72 159.186C-9.536 172.2-1.86 173.43-4.146 179.89" fill="none" strokeWidth=".611" />
              <path
                d="M-17.009 148.833l-4.322 4.322 28.092 19.448-19.448-28.091-4.322 4.321 23.77 23.77"
                strokeWidth=".611"
              />
              <path
                d="M-17.009 148.833l4.322-4.321-4.322 4.321 23.77 23.77-19.448-28.091"
                fill="#7b3f00"
                stroke="none"
              />
            </g>
